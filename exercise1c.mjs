...
// 3b. Take the age of the buyer. Do not proceed if the buyer is less than age 10 years. 
...
while (true) {
  ...
  // 2. Restrict the age to be between 10 and 100 inclusive
  if (age >= 10) {
    break;
  } else {
    // 3. Alter the message to match the if condition
    console.log('You have to be 10 years or above to purchase an item(s)');
  }
}
